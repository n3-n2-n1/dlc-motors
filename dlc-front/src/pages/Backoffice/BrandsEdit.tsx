...
import { updateBrands } from "../../utils/Handlers/Handlers";
const BrandsEdit = () => {
  ...
  return (
    <div className="p-4 md:p-6 dark:bg-gray-900  dark:text-white overflow-auto">
      <Navbar title="Marcas" subtitle="¿Qué marca querés editar?" />
      <div>
        <select
