...
import { updateCategories } from "../../utils/Handlers/Handlers";
...
const CategoriesEdit = () => {
  ...
  const [arrays, setArrays] = useState({categories});
  ...
  const handleSubmit = () => {
    updateCategories(arrays.categories)
  };
  ...
  return (
    <div className="p-4 md:p-6 dark:bg-gray-900  dark:text-white">
      <Navbar title="Rubros" subtitle="¿Qué rubro querés editar?" />
      <div>
        <select
