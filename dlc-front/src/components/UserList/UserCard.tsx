...
const UserCard = ({ user }) => {
  ...
  {isEditing ? (
    <form
      ...
      className="bg-gray-200 dark:bg-gray-700 p-4 rounded-2xl px-6"
    >
          <input
            type="text"
        ...
        <div className="bg-gray-100 dark:bg-gray-900 flex flex-col justify-center items-center p-4">
        <div className="bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-white max-w-md flex flex-col rounded-xl shadow-lg p-4 w-full">
          <div className="flex items-center justify-between">
            ...
            <div className="mt-4 text-gray-600 dark:text-gray-300 font-bold text-sm">Rol: {user.role}</div>
          </div>
        </div>
      )}
    </div>
